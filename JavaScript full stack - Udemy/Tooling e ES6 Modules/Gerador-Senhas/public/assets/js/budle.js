...
//Aqui será trabalhado a captura das coisas, como div, checkbox ....
...
var geraMaiusculas = function geraMaiusculas() {
  return String.fromCharCode(rand(65, 91));
};

var geraMinusculas = function geraMinusculas() {
  return String.fromCharCode(rand(97, 103));
};
...
function geraSenha(qtd, maiusculas, minusculas, numeros, simbolos) {
  var SenhaArray = []; //Mais facil de jogar os caracteres na senha.
